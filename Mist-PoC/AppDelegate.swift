...
extension AppDelegate {
    ...
    func configureAndStartMistService() {
        ...
        let payload = NotificationData(title: "Mist", subtitle: "Mist Service Started", body: "Please minimize the app to receive the notification")
        Notification.schedule(after: 2.0, payload: payload)
#endif
